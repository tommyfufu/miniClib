...
#define __LIBMINI_H__ /* leravoid reentrant */
...
#define IG_DFL ((sighandler_t) 0)   // default
...
int sigaction(int signum, struct sigaction *new_handler, struct sigaction *old_handler);
